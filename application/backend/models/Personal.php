...
class Personal extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['first_name', 'last_name', 'middle_name', 'city_address', 'cellphone_no', 'date_of_birth', 'age', 'status', 'sex', 'place_of_birth', 'nationality', 'height', 'weight', 'religion'], 'required'],
            [['cellphone_no', 'age'], 'integer'],
            [['date_of_birth'], 'safe'],
            [['status', 'sex'], 'string'],
            [['height', 'weight'], 'number'],
            [['first_name', 'last_name', 'middle_name', 'place_of_birth', 'nationality', 'religion'], 'string', 'max' => 30],
            [['city_address'], 'string', 'max' => 45]
        ];
    }
